 ...
 *
 */
public class AcquisitionPlannerTask {
	 ...
	 */
	public AcquisitionPlannerTask(PlanningProblem planningProblem){
	...
	public static void main(String[] args) throws XMLStreamException, FactoryConfigurationError, IOException{
		...
		pb.printStatistics();
		AcquisitionPlannerTask planner = new AcquisitionPlannerTask(pb);
